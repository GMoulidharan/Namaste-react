    ...
    return(
        <div className='res-card'>
            <img
             className='res-logo'
             alt='res-logo'
             src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/RX_THUMBNAIL/IMAGES/VENDOR/2024/4/17/" + cloudinaryImageId}/>
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
            <h4>{avgRating}</h4>
...
const resList = [
    {
        ...
        data: {
          ...
          cloudinaryImageId: "1b92e544-fce7-45ac-941a-50092e3037a5_66148.JPG",
